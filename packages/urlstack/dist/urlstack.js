...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('urlhub/nodeStrategy')) :
	typeof define === 'function' && define.amd ? define(['urlhub/nodeStrategy'], factory) :
	(global.urlstack = factory(global.nodeStrategy));
}(this, (function (nodeStrategy) { 'use strict';

	nodeStrategy = nodeStrategy && nodeStrategy.hasOwnProperty('default') ? nodeStrategy['default'] : nodeStrategy;
	...
	*/
	...
	var pushStrategy = {
	  ...
	  emit: function(){
	    onChange$1 && onChange$1( this.getLocation() );
	  }
	};
